  ...
  const fetchTableDataList_Fn = async () => {
    ...
    try {
      const response = await axios.post(
        url + 'index.php/webApi/Admapi/adm_approv_list', cread, // Empty body
        {
          headers: {
            'auth_key': auth_key,
          },
      ...
      console.log("Response Data Table:", response.data.message); // Log the actual response data
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <td scope="row" class="px-4 py-3">
                        ...
                        onClick={() => {
                            navigate(`/home/admin_approval/AdApcrud/${data?.approval_no}`);
