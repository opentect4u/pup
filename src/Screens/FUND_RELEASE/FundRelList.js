  ...
  return (
    ...
    <div class="mx-auto max-w-screen-xl  ">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <h2 className='text-xl font-bold text-white'>Fund List</h2>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-slate-200 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Installment Amount </th>
                            <th scope="col" class="px-4 py-3">Allotment Order No.</th>

                            <th scope="col" class="px-4 py-3">Schematic Amount</th>
                            <th scope="col" class="px-4 py-3">Contigency Amount</th>
                    ...
                    <td scope="row" class="px-4 py-3">{data?.instl_amt}</td> 
                    <td scope="row" class="px-4 py-3"><a href={url + folderName + data?.allotment_no} target='_blank'>
                        <FilePdfOutlined style={{fontSize:22, color:'red'}} /></a></td>

                    <td scope="row" class="px-4 py-3">{data?.sch_amt}</td>
                    <td scope="row" class="px-4 py-3">{data?.cont_amt}</td>
