...
function SOUR_OF_FUN_Form() {
                  ...
                  <tbody>
                    {currentTableData.map((data, index) => (
                      <tr key={index} className="border-b">
                        ...
                        <td className="px-4 py-3">{data?.fund_type}</td>
  ...
  Showing {(currentPage - 1) * rowsPerPage + 1} to {Math.min(currentPage * rowsPerPage, fundDropList.length)} of {fundDropList.length}
  </span>
