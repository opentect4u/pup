...
function HeadAccountwise_Report() {
  ...
  const showReport = async (params) => {
    ...
    formData.append("account_head_id", formik.values.head_acc);
  ...
  // Download & Print Function Start 
    ...
    const printData = (para) => {
      ...
      printWindow.document.write(`
        ...
        <h2>${PrintPageName.HeadAcc} Year: ${printYear} Head of Account: ${printSecoundField}</h2>
      `);
    ...
    <section className="bg-white p-5 dark:bg-gray-900">
      <div className="py-5 mx-auto w-full lg:py-5">
        <div className="grid grid-cols-1 gap-4">
          ...
          <form onSubmit={formik.handleSubmit}>
            <div class="grid gap-4 sm:grid-cols-12 sm:gap-6">
              ...
              dark:focus:ring-blue-800 ml-auto"
                  onClick={() => {
                    navigate(`/home/report/head-accountwise-report-graph/${financeYear_submit == "" ? params?.id : financeYear_submit}`, {
                      state: {
          ...
          {/* {JSON.stringify(formik.values.head_acc, null, 2)} /// {JSON.stringify(secoundValue, null, 2)} */}
          <Spin
